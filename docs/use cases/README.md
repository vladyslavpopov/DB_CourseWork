...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | 1. AccountNotFoundException — обліковий запис не знайдено, або він вже видалений.<br>2. InsufficientPermissionException — адміністратор намагається видалити обліковий запис, до якого у нього немає доступу. |
...
note right #FF6969
<b> Можливі виключні ситуації:
<b> InsufficientPermissionException
end note

: Обліковий запис видалено успішно;
note right #FF6969
<b> Можлива виключна ситуація:
...
| **ОСНОВНИЙ СЦЕНАРІЙ** | 1. Адміністратор відкриває панель управління.<br>2. Вибирає користувача, чию роль потрібно підвищити.<br>3. Адміністратор вибирає нову роль для користувача.<br>4. Система обробляє запит і змінює роль користувача.<br>5. Адміністратор отримує повідомлення про успішне підвищення ролі.<br>6. Адміністратор завершує сесію. |
...
: Роль користувача змінена успішно;
note right #FF6969
<b> Можлива виключна ситуація:
